...
def main() -> None:
    ...
    card_specs = {
        ...
        10: ("Evidence supports a controlled demo", "Measured results and open gates", ["88 tests; 84% Python branch coverage", "22 deterministic architecture gates", "Two exact controlled synthetic workflows", "Open: domain eval, accessibility, penetration, signed deployment"], None),
    }
